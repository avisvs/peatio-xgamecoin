RSpec.describe Peatio::Xgamecoin::Wallet do
  let(:wallet) { Peatio::Xgamecoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Xgamecoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Xgamecoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
